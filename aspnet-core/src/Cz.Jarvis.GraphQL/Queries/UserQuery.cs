...
using Cz.Jarvis.Core.Base;
using Cz.Jarvis.Dto;
using Cz.Jarvis.Types;
using Cz.Jarvis.Core.Extensions;
using GraphQL;

namespace Cz.Jarvis.Queries
{
    public class UserQuery : JarvisQueryBase<UserPagedResultGraphType, PagedResultDto<UserDto>>
    {
