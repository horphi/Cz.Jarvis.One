...
using Cz.Jarvis.Authentication.PasswordlessLogin;
using Cz.Jarvis.Authorization.PasswordlessLogin;

namespace Cz.Jarvis.Authorization.Accounts
{
    public class AccountAppService : JarvisAppServiceBase, IAccountAppService
    {
        ...
        private async Task SendSmsPasswordlessCode(string phoneNumber)
        {
            ...
            var message = string.Format(L("PasswordlessLogin_SmsMessage", JarvisConsts.ProductName, code));
