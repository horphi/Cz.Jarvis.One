...
{
    [AbpAuthorize]
    public class NotificationAppService : JarvisAppServiceBase, INotificationAppService
    {
        ...
        public async Task CreateMassNotification(CreateMassNotificationInput input)
        {
            ...
            if (userIds.Count == 0)
            {
                throw new UserFriendlyException(L("MassNotificationUserFieldIsRequiredMessage"));
            }
