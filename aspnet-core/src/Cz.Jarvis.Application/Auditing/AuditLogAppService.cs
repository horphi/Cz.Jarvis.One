...
using Cz.Jarvis.Auditing.Exporting;
...
using EntityHistoryHelper = Cz.Jarvis.EntityHistory.EntityHistoryHelper;

namespace Cz.Jarvis.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : JarvisAppServiceBase, IAuditLogAppService
    {
        ...
        {
            // Fix for: https://github.com/czjarvis/aspnet-zero-core/issues/2101
