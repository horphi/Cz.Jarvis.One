...
namespace Cz.Jarvis.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : JarvisServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Cz.Jarvis", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
