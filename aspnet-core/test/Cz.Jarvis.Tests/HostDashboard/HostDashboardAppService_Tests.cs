...
using Cz.Jarvis.MultiTenancy.HostDashboard;
using Cz.Jarvis.MultiTenancy.HostDashboard.Dto;
using Cz.Jarvis.MultiTenancy.Payments;
using Shouldly;
using System.Globalization;
using Cz.Jarvis.EntityFrameworkCore;
using Cz.Jarvis.ExtraProperties;

namespace Cz.Jarvis.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(JarvisDbContext context, SubscriptionPayment subscriptionPayment)
        {
